# -*- coding: utf-8 -*-
"""
Created on Tue Mar  5 14:47:04 2019
...
class Calculator:
    def __init__(self,master):
        ...
        self.screen=Text(master,state='disabled',height=3,width=30,foreground="blue",background="yellow")
        ...
        b5=self.createButton(6)
        b6=self.createButton(5)
        b7=self.createButton(4)
        b8=self.createButton(u"\u00F7")
        b9=self.createButton(3)
        ...
        for row in range(1,5):
            for col in range(4):
                ...
                count+=1
        buttons[16].grid(row=5,column=0,columnspan=5)
